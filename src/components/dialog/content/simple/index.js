...
`
const Simple = ({ grayFooter, closeDialog, onCancel, onConfirm, confirmText, cancelText, title, text }) => {
    ...
    return (
        <div>
            ...
            `}>
                <ConfirmButton tailwind={`text-white bg-red-600 my-2 md:m-2 md:mr-0 focus:border-red-700
